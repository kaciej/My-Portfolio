                        ...
                        <div className="imgs wow fadeIn" data-wow-offset="70" data-wow-delay=".25s" data-wow-iteration="1"
                            ...
                            <div className="overlay">
                                <div className="chello hover-text">
                                    ...
                                    <a target="_blank" rel="noopener noreferrer" href="https://github.com/kaciej/chello-farms"><button className="btn code-btn">code here</button></a> 
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="imgs wow fadeIn" data-wow-offset="70" data-wow-delay=".5s" data-wow-iteration="1"
                            ...
                            <div className="overlay">
                                <div className="clean-air hover-text">
                                    ...
                                    <a target="_blank" rel="noopener noreferrer" className="code-btn" href="https://github.com/Coo-coo-kachoo/Clean-Air-SLC"><button className="btn code-btn">code here</button></a> 
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="imgs wow fadeIn" data-wow-offset="70" data-wow-delay=".75s" data-wow-iteration="1"
                            ...
                            <div className="overlay">
                                <div className="unschooling hover-text">
                                    ...
                                    <a target="_blank" rel="noopener noreferrer" className="code-btn" href="https://github.com/kaciej/Unschooling"><button className="btn code-btn">code here</button></a> 
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="imgs wow fadeIn" data-wow-offset="70" data-wow-delay="1s" data-wow-iteration="1"
                            ...
                            <div className="overlay">
                                <div className="robin hover-text">
                                    ...
                                    <a target="_blank" rel="noopener noreferrer" className="unschool-site" href="https://www.southernflarelash.com/#/">https://www.southernflarelash.com/#/</a>
                                    <a target="_blank" rel="noopener noreferrer" className="code-btn" href="https://github.com/ElloraDevelopment/southern-flare-lash2/branches"><button className="btn code-btn">code here</button></a> 
                                </div>
                            </div>
                        </div>
                    </div>
